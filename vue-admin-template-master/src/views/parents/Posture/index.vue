<template>
    <div>
      ...
      <el-card>
        <div v-show="scenen == 0">
          <el-button type="primary" icon="el-icon-plus" @click="addSpu">实时查看坐姿</el-button>
          <el-table style="width:100%" border :data="list">
            <el-table-column type="index" label="序号" width="80" align="center"></el-table-column>
            <el-table-column prop="name"  label="学生名称" width="150" ></el-table-column>
            <el-table-column prop="num"  label="学生学号" width="150" ></el-table-column>
            <el-table-column prop="time"  label="时间" width="150"></el-table-column>
            <el-table-column prop="imgUrl" label="坐姿图片信息" width="width">
              <template>
                <img :src="list.imgUrl" style="width: 100px; height: 100px" />
              </template>
            </el-table-column>
            <el-table-column prop="description"  label="学情信息描述"></el-table-column>
            <el-table-column prop="prop"  label="操作">
              <template slot-scope="{row,$index}">
                  <el-button type="success" icon="el-icon-plus" size="mini" title="添加学情信息" @click="scenen = 1"></el-button>
                  <el-button type="warning" icon="el-icon-edit" size="mini" title="修改学情信息" @click="updateSpu(row)"></el-button>
         ...
         <!--对话框-->
    <el-dialog title="实时坐姿" :visible.sync="dialogFormVisible">
      <!--
        表单验证
  ...
  export default {
      ...
      data() {
        return {
          ...
          scenen:0, //根据该值来切换页面，
          list:[
            {id:'001',name:'张三',num:'212211111',description:'全勤',imgUrl:'',time:'2022/11/26'},
            {id:'002',name:'李四',num:'212211112',description:'全勤',imgUrl:'',time:'2022/11/26'},
          ],
            //显示对话框
